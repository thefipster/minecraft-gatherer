...
namespace TheFipster.Minecraft.Speedrun.Services
{
    public class ServerPropertiesReader : IServerPropertiesReader
    {
        ...
        {
            var filePath = Path.Combine(_config.ServerLocation.FullName, ServerPropertiesFilename);
            ...
            throw new Exception($"File {ServerPropertiesFilename} was not found in {_config.ServerLocation.FullName}");
        }
