...
{
    public class TimingSearchSectionDecorator : ITimingAnalyzer
    {
        private readonly ITimingAnalyzer _component;

        public TimingSearchSectionDecorator(ITimingAnalyzer component)
        ...
        public TimingAnalytics Analyze(RunImport run)
        {
            ...
            var timingEvent = new TimingEvent(RunSections.Search);
