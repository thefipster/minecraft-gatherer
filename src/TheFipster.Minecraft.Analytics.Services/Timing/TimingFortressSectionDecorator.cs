...
{
    public class TimingFortressSectionDecorator : ITimingAnalyzer
    {
        private readonly ITimingAnalyzer _component;

        public TimingFortressSectionDecorator(ITimingAnalyzer component)
        ...
        public TimingAnalytics Analyze(RunImport run)
        {
            ...
            var timingEvent = new TimingEvent(Sections.Fortress);
